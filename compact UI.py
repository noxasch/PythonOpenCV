...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(364, 121)
        self.centralwidget = QtGui.QWidget(MainWindow)
        self.centralwidget.setObjectName(_fromUtf8("centralwidget"))
        self.stop_btn = QtGui.QPushButton(self.centralwidget)
        self.stop_btn.setGeometry(QtCore.QRect(40, 70, 161, 23))
        self.stop_btn.setObjectName(_fromUtf8("stop_btn"))
        self.start_btn = QtGui.QPushButton(self.centralwidget)
        self.start_btn.setGeometry(QtCore.QRect(40, 40, 161, 23))
        self.start_btn.setObjectName(_fromUtf8("start_btn"))
        self.finish_btn = QtGui.QPushButton(self.centralwidget)
        self.finish_btn.setGeometry(QtCore.QRect(240, 40, 75, 23))
        self.finish_btn.setObjectName(_fromUtf8("finish_btn"))
        self.add_person_btn = QtGui.QPushButton(self.centralwidget)
        self.add_person_btn.setGeometry(QtCore.QRect(40, 10, 161, 23))
        self.add_person_btn.setObjectName(_fromUtf8("add_person_btn"))
        self.capture_btn = QtGui.QPushButton(self.centralwidget)
        self.capture_btn.setGeometry(QtCore.QRect(240, 10, 75, 23))
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "Administrator Panel", None))
        self.stop_btn.setText(_translate("MainWindow", "Stop Face Recognition", None))
        self.start_btn.setText(_translate("MainWindow", "Start Face Recognition", None))
